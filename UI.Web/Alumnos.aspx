...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
        ...
        <asp:Panel ID="formPanel" runat="server" Visible="False">
            <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="dtNacimiento" TextMode="Date" runat="server"></asp:TextBox>
                            </td>
                        </tr>
						<tr>
						...
						<tr>
                            ...
                            <td><asp:DropDownList ID="ddlIdPlan" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
						<tr>
    ...
    <asp:Panel ID="Panel3" runat="server">
        ...
        <asp:LinkButton ID="nuevoLinkButton" runat="server">Agregar</asp:LinkButton>
    </asp:Panel>
