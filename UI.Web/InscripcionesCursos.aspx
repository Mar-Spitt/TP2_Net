...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <div id="container">
        <asp:Label ID="Label1" runat="server" Text="INSCRIPCIONES A CURSOS"></asp:Label>
    </div>
    
    <div id="margen"></div>
	<section id="content">
		<asp:Panel ID="Panel1" runat="server">
            <h3>Seleccione el curso que desea inscribirse </h3>
                <asp:GridView ID="gvInscripcionesCursos" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="ID" OnSelectedIndexChanged="gvInscripcionesCursos_SelectedIndexChanged">
        ...
        <asp:Panel ID="Panel3" runat="server">
                <asp:LinkButton ID="inscribirlinkButton" runat="server" OnClick="inscribirlinkButton_Click">Inscribirme</asp:LinkButton>
            </asp:Panel>
    </section>
                        ...
                        <table border="1" align="right">
						    <tr>
							    <td align="center" colspan="2">
                                    ...
                                    &nbsp;DE LA INSCRIPCION</strong></td>
						    </tr>
						    <tr>
							    <td align="right">Alumno</td>
                                <td>
                                    <asp:TextBox ID="txtIdAlumno" runat="server" Width="25"></asp:TextBox><asp:TextBox ID="txtNombreAlumno" runat="server"></asp:TextBox>
                                </td>
						    </tr>
						    <tr>
							    <td align="right">Curso</td>
                                <td>
                                    <asp:TextBox ID="txtIdCurso" runat="server" Width="25"></asp:TextBox><asp:TextBox ID="txtDescripcionCurso" runat="server"></asp:TextBox>
                                </td>
						    </tr>
						    <tr>
